...
//    static var ypGrays: UIColor { UIColor(named: "YP Gray") ?? UIColor.gray }
//    static var ypWhites: UIColor { UIColor(named: "YP White") ?? UIColor.white}
//    static var ypBackgrounds: UIColor { UIColor(named: "YP Background") ?? UIColor.black}
//}
